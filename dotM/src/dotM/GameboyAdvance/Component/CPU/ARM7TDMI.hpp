...
#pragma region Single Data Swap
		...
		void i_swp(Register<dword>& rd, Register<dword>& rm, dword rn, bool bFlag);
#pragma endregion
...
#pragma region Halfword Data Transfer
		...
		void i_ldrh(Register<dword>& rd, dword address);
		void i_strh(Register<dword>& rd, dword address);
		void i_ldrsb(Register<dword>& rd, dword address);
		void i_ldrsh(Register<dword>& rd, dword address);
#pragma endregion
#pragma region Single Data Transfer
		void single_data_transfer(const Instruction<dword>& instruction);

		void i_ldr(Register<dword>& rd, dword address, bool isByte);
		void i_str(Register<dword>& rd, dword address, bool isByte);
#pragma endregion
...
#pragma region ALU Operations
		...
		void it_and(Register<dword>& rd, dword rs);
		void it_eor(Register<dword>& rd, dword rs);
		void it_lsl(Register<dword>& rd, dword rs);
		void it_lsr(Register<dword>& rd, dword rs);
		void it_asr(Register<dword>& rd, dword rs);
		void it_adc(Register<dword>& rd, dword rs);
		void it_sbc(Register<dword>& rd, dword rs);
		void it_ror(Register<dword>& rd, dword rs);
		void it_tst(Register<dword>& rd, dword rs);
		void it_neg(Register<dword>& rd, dword rs);
		void it_cmp(Register<dword>& rd, dword rs);
		void it_cmn(Register<dword>& rd, dword rs);
		void it_orr(Register<dword>& rd, dword rs);
		void it_mul(Register<dword>& rd, dword rs);
		void it_bic(Register<dword>& rd, dword rs);
		void it_mvn(Register<dword>& rd, dword rs);
#pragma endregion
...
#pragma endregion
		...
		Pipeline<Instruction<dword>, 3> m_pipeline{};                          //Construct a pipeline with 3 stages
		Pipeline<Instruction<word>, 3> m_pipeline2{};                          //rename
		std::array<dword, 3> m_instructionAddresses{};                         //Contains 32-bit addresses of the pipeline instructions
